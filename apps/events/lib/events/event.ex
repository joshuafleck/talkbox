defmodule Events.Event do
  ...
  ## Examples
      ...
      iex(25)> Events.Event.serialize(%Events.UserRequestsCall{callee: "amy", user: "josh"})
      "{\"name\":\"Elixir.Events.UserRequestsCall\",\"data\":\"{\\\"user\\\":\\\"josh\\\",\\\"callee\\\":\\\"amy\\\"}\"}"
  """
  ...
  ## Examples
      ...
      iex(1)> Events.Event.deserialize("{\"name\":\"Elixir.Events.UserRequestsCall\",\"data\":\"{\\\"user\\\":\\\"josh\\\",\\\"callee\\\":\\\"amy\\\"}\"}")
      %Events.UserRequestsCall{callee: "amy", user: "josh"}
  """
