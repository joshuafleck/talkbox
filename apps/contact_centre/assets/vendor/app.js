...
var _user$project$Conference$CallLeg = F5(
	function (a, b, c, d, e) {
		return {identifier: a, destination: b, callStatus: c, callSid: d, hangupRequested: e};
	});
var _user$project$Conference$decodeCallLeg = A6(
...
var _user$project$Conference$Model = F2(
	function (a, b) {
		return {identifier: a, participants: b};
	});
var _user$project$Conference$decodeConference = A3(
	_elm_lang$core$Json_Decode$map2,
...
var _user$project$Conference$viewCallLeg = function (callLeg) {
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
...
var _user$project$Conference$allCallLegs = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (participant) {
			return _user$project$Conference$viewCallLeg(participant);
		},
		model.participants);
};
...
var _user$project$App$decodeCallRequestFailure = A2(
	...
	_elm_lang$core$Json_Decode$string);
var _user$project$App$encodedCallLeg = F2(
...
var _user$project$App$encodedCall = F3(
	function (callee, user, conference) {
...
var _user$project$App$RequestSubmitted = function (a) {
	return {ctor: 'RequestSubmitted', _0: a};
};
...
var _user$project$App$sendStartCall = F2(
	function (model, callee) {
		return A4(
			...
			A3(_user$project$App$encodedCall, callee, model.clientName, model.conference));
	});
	...
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			case 'SetupTwilio':
				...
				if (_p5.ctor === 'Ok') {
					return {
						...
						_1: _user$project$Twilio$setup(_p5._0)
					};
				} else {
					return {
						ctor: '_Tuple2',
			...
			case 'ConferenceStarted':
				...
				if (_p6.ctor === 'Ok') {
					var _p8 = _p6._0;
					var conference = _p8.conference;
					var _p7 = A2(_user$project$App$joinConferenceChannel, model, conference);
			...
			case 'ConferenceEnded':
				...
				if (_p9.ctor === 'Ok') {
					var _p11 = _p9._0;
					var conference = _p11.conference;
					var _p10 = A2(_user$project$App$leaveConferenceChannel, model, conference);
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{conference: _elm_lang$core$Maybe$Nothing, conferenceStatus: _p11.message, phxSocket: phxSocket}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App$PhoenixMsg, phxCmd)
					};
				} else {
					return {
				...
				if (_p12.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								conference: _elm_lang$core$Maybe$Just(_p13.conference),
								conferenceStatus: _p13.message
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
				...
				if (_p14.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								status: A2(_elm_lang$core$Basics_ops['++'], 'Request failed with error: ', _p14._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			default:
				var _p24 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p4._0, model.phxSocket);
