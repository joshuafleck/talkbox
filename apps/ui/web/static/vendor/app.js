	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			case 'CallStatusChanged':
				var decodeResult = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$App$decodeCall, _p3._0);
				var _p4 = decodeResult;
				if (_p4.ctor === 'Ok') {
					var _p6 = _p4._0;
					var _p5 = A2(
						_user$project$Line$update,
						_user$project$Line$CallStarted(_p6),
						model.line);
					var updatedLineModel = _p5._0;
					var lineCmd = _p5._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								status: A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_p6.sid,
										A2(_elm_lang$core$Basics_ops['++'], ' ', _p6.status))),
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								status: A2(_elm_lang$core$Basics_ops['++'], 'Failed to decode call: ', _p4._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'CallEnded':
				var _p7 = A2(_user$project$Line$update, _user$project$Line$CallEnded, model.line);
				var updatedLineModel = _p7._0;
				var lineCmd = _p7._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			case 'SetupTwilio':
				var decodeResult = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$App$decodeTwilioToken, _p3._0);
				...
				if (_p8.ctor === 'Ok') {
					return {
						...
						_1: _user$project$Twilio$setup(_p8._0)
					};
				} else {
					return {
						ctor: '_Tuple2',
